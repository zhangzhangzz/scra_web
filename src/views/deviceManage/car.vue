 ...
 * @LastEditTime: 2021-06-04 15:46:10
-->
...
<template>
    <div class="projectSpeed">
        ...
        <el-row>
            <el-col :span="24">
                ...
                <el-table
                    ...
                    label="入场图片">
                        <template slot-scope="scope">
                            <img :src="scope.row.rctp" style="height:50px;width:auto">
                        </template>
                    </el-table-column>
                    <el-table-column
                    prop="lcsj"
                    ...
                    label="离场图片">
                        <template slot-scope="scope">
                            <img :src="scope.row.lctp" style="height:50px;width:auto">
                        </template>
                    </el-table-column>
        ...
        <el-row>
            <el-col :span="24" class="pageWapper">
                <el-pagination
    ...
    export default {
        data() {
            ...
            const item1 = {
                ...
                cph: '粤G3N899',
                sbbh:'GGDFHGGFYUJHU45',   
                rcsj:'2020-09-10 09:12:23',
                rctp:'https://gimg2.baidu.com/image_search/src=http%3A%2F%2F01.imgmini.eastday.com%2Fmobile%2F20180413%2F20180413104635_92b653e09f7988e724edf2f6e9919159_9.jpeg&refer=http%3A%2F%2F01.imgmini.eastday.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1623287090&t=35409dfe91c8c8676220fc90aa5ef1c4',
                lcsj:'2020-09-10 09:12:23',
                lctp:'https://gimg2.baidu.com/image_search/src=http%3A%2F%2F01.imgmini.eastday.com%2Fmobile%2F20180413%2F20180413104635_92b653e09f7988e724edf2f6e9919159_9.jpeg&refer=http%3A%2F%2F01.imgmini.eastday.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1623287090&t=35409dfe91c8c8676220fc90aa5ef1c4'
            };
            return {
