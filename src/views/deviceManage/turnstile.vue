 ...
 * @LastEditTime: 2021-05-11 09:23:18
-->
    ...
    <div class="projectSpeed">
        <el-row>
            <el-col :span="24" class="formWapper row">
                <el-col :span="3" class="mr" style="margin: 0 auto 0 0">
                    闸机管理
                </el-col>
                ...
                <el-button type="primary"  class="sureBtn" style="margin-left:10px" @click="dialogVisible=true">添加设备</el-button>
            </el-col>
        </el-row>
        <el-row>
            <el-col :span="24">
                <el-table
                    ...
                    <el-table-column label="操作" width="200" align="center">
                        <template slot-scope="scope">
                            <span @click="dialogVisible=true" class=" czBtn btn1">编辑</span>
                            <span @click="handleOut(0)" class="btn2">删除</span>
                        </template>
                    </el-table-column>
                </el-table>
            </el-col>
