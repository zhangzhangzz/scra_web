<!--
 * @Author: your name
 * @Date: 2021-10-18 09:48:06
 * @LastEditTime: 2021-10-18 10:18:08
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \scra_web1 - 副本\src\views\applicationManage\scdscragy\scdscragy.vue
-->
<template>
    <div class="projectSpeed" style="height:100%;overflow-y: auto;">
                    ...
                    <el-col :span="24" >
                        <el-table
                            ...
                            <el-table-column label="操作" :width="user.userType!==1?180:80" align="center" fixed="right">
                                <template slot-scope="scope" >
                                    <el-button @click="jumpPz(scope)" type="text" size="small" >修改</el-button>
                                    <el-button  type="text" size="small" @click="setDevice(scope.row)" >启用</el-button>
                                </template>
                            </el-table-column>
                        </el-table>
                    </el-col>
        ...
        <el-dialog
            ...
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="120px" class="demo-ruleForm">
                <el-form-item label="项目名称" prop="comRecDistModeType"> 
                    <div class="fw">
                        <el-input v-model="ruleForm.comRecTimeWindow" type="number" disabled></el-input>
                    </div>
                </el-form-item>
                <el-form-item label="设备ID" prop="comRecRank"> 
                    <div class="fw">
                        <el-input v-model="ruleForm.comRecTimeWindow" type="number" disabled></el-input>
                    </div>
                </el-form-item>
                <el-form-item label="建委国控" prop="repeatRegEnable"> 
                    <div class="fw">
...
import {cjDeviceList,addDevice,deleteDevice,setDevice,fuzzyQuery,pullAttendByDevice} from '@/api/api.js'
...
export default {
    ...
    methods: {
        jumpPz(scope){
            if(this.type === 1){
                this.$router.push({path: 'docking',query: {deviceId:scope.row.deviceId,type:1,pageNumber:this.page,limit:this.pageSize,globalProjectId:this.globalProjectId===''?'':this.globalProjectId.id,deviceName:this.deviceName,onlineStatus:this.onlineStatus===''?null:this.onlineStatus,hick:this.type}})
            }else{
                this.$router.push({path: 'docking',query: {deviceId:scope.row.deviceId,type:1,pageNumber:this.page,limit:this.pageSize,globalProjectId:'',deviceName:'',onlineStatus:null,hick:this.type}})
            }
        },
