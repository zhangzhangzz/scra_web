<template>
  <div style="height:100%;overflow-y: auto;" class="perAge" ref="bigbox">
    <div  class="all" style="min-height:calc(100% - 47px)">
      <ul class="sys_top" >
        ...
        <li class="sys_top_1 row" >
          <span class="spanM" style="line-height:36px;width:80px">人员状态</span>
          <div style="width:180px">
        ...
        <div class="secBtn" @click="countDel" style="margin-left:10px">删除</div>
      </ul>
      <div class="sys_bottom" >
        ...
        >
          ...
          <template slot-scope="scope">
              ...
              <el-button @click="li(tableData)" type="text" size="small">退场</el-button>
